...
namespace Negocio.Proceso.DependencyResolution
{
    public class RepositoryConfiguration : IRepositoryConfiguration
    {
        public void Configure(string ConnectionString, string dbSchema)
        {
            ...
            ObjectFactory.Configure(container =>
            {
                ...
                container.For(typeof(IApplication)).LifecycleIs(InstanceScope.Hybrid).Use(typeof(GenericApplicationConsola));
                ...
                //container.For(typeof(IPeriodoAcademicoService)).LifecycleIs(InstanceScope.PerRequest).Use(typeof(PeriodoAcademicoService));
